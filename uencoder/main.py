...
import machine, sys
import gc
from encoder import Encoder  # Import RotaryEncoder module created in /lib folder
gc.collect()
...
EncoderSet = {}
logger_encoder = setup_logging(logfile, 'custom', 'encoder', 1, True, logger_log_level=20)
device = 'encoder1'
lvl2 = b'encoder'
publvl3 = ESPID + b""
data_keys = ['rpm1i']
...
EncoderSet[device] = Encoder(dtPin, rpmkey='rpmi', pulses_per_rev=20.0, min_RPM=5.0, logger=logger_encoder)
